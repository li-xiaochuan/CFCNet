...
from models.CFCNet import build_net
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='CFCNet', type=str)
    parser.add_argument('--data', type=str, default='Haze4K', choices=['ITS', 'Haze4K', 'NHR', 'GTA5', 'real_haze'])

    parser.add_argument('--mode', default='train', choices=['train', 'test'], type=str)
    parser.add_argument('--data_dir', type=str, default='your_path/Haze4K')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='Best-4k.pkl')
    ...
    os.system(command)
    command = 'cp ' + 'models/CFCNet.py ' + args.model_save_dir
    os.system(command)
